...
func (ps *PaymentStore) InsertPayment(ctx context.Context, payment *model.Payment) error {
...
func (ps *PaymentStore) InsertPaymentImpactedCommitment(ctx context.Context, pic *model.PaymentImpactedCommitment) error {
